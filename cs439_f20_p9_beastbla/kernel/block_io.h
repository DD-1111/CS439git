...
public:
    ...
    virtual void write_block(uint32_t block_number, char* buffer) = 0;
    ...
    virtual int64_t read(uint32_t offset, uint32_t n, char* buffer);
     virtual int32_t write(uint32_t offset, uint32_t n, char* buffer);
    ...
    virtual int64_t write_all(uint32_t offset, uint32_t n, char* buffer);
